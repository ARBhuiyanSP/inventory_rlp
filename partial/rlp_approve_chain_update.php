                            ...
                            <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <select class="form-control" id="rlp_type" name="rlp_type">
                                        <option value="">Please select</option>
                                       <option value="1" <?php if(isset($chainDetails->rlp_type) && $chainDetails->rlp_type == 1){ echo 'selected'; } ?>>General RLP</option>
									   <option value="2" <?php if(isset($chainDetails->rlp_type) && $chainDetails->rlp_type == 2){ echo 'selected'; } ?>>Stationary RLP</option>
									   <option value="3" <?php if(isset($chainDetails->rlp_type) && $chainDetails->rlp_type == 3){ echo 'selected'; } ?>>EHS RLP</option>
									   <option value="4" <?php if(isset($chainDetails->rlp_type) && $chainDetails->rlp_type == 4){ echo 'selected'; } ?>>Battery Stationary RLP</option>
