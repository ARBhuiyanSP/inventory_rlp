...
<form action="" method="post">
		...
		<div class="col-sm-4">
			<div class="form-group">
				<label for="sel1">RLP Type:</label>
				 ...
				 <input type="text" class="form-control" value="<?php echo getRlpTypeNameById($rlp_type); ?>" readonly />
				 <input name="request_rlp_type" type="hidden" value="<?php echo $rlp_type; ?>" />
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php echo get_user_department_type_wise_rlp_chain_for_create($division_id, $department_id,$rlp_type); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
