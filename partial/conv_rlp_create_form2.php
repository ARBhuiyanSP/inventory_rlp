...
<form action="" method="post">
    <div class="row">
		...
		<input type="hidden" class="form-control" value="Conveyance" name="rlp_type" />
	</div>
	<div class="row">
		<div class="col-sm-4">
            <div class="form-group">
                                    ...
                                    <tr>
                                        <td>
                                            <select class="form-control material_select_2" id="material_name" name="material_name[]" required onchange="getItemCodeByParam(this.value, 'inv_material', 'material_id_code', 'material_id0', 'qty_unit', 'part_no');">
                                                ...
                                                <?php
                                                $projectsData = get_conveyance_with_category();
 ...
 $(document).ready(function () {
    ...
    <div class="row">
        <div class="col-sm-12">
            <input type="submit" name="conv_rlp_create" id="submit" class="btn btn-block btn-primary" value="Request" />
        </div>
    </div>
</form>
