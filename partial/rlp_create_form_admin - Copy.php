		...
		<div class="col-sm-2">
            <div class="form-group">
                ...
                <select name="type" class="form-control" required>
					...
					<option value="1" <?php if(isset($_POST['type']) && $_POST['type']==1){echo 'selected';} ?>>General RLP</option>
					<option value="2" <?php if(isset($_POST['type']) && $_POST['type']==2){echo 'selected';} ?>>Stationary RLP</option>
					<option value="3" <?php if(isset($_POST['type']) && $_POST['type']==3){echo 'selected';} ?>>EHS RLP</option>
					<option value="4" <?php if(isset($_POST['type']) && $_POST['type']==4){echo 'selected';} ?>>Battery Stationary RLP</option>
				</select>
            </div>
		</div>
		<div class="col-sm-2">
			<div class="form-group">
				...
				<input type="submit" name="getchain" id="getchain" class="form-control btn btn-block btn-primary" value="Approval Chain" />
			</div>
		</div>
	</div>
</form>
...
<form action="" method="post">
    <div class="row" style="background-color:#CDEFF7;">
		...
		<div class="col-sm-2">
            <div class="form-group">
                <label for="exampleId">RLP Type</label>
                <input type="text" class="form-control" name="rlp_type"  value="<?php echo $type; ?>" readonly>
