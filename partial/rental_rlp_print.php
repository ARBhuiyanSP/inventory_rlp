...
<section class="invoice" id="printableArea">
    ...
    <div class="row">
		...
		<div class="col-sm-12">	
					<center>
						<p>
							<img src="images/rental-rlp-logo.png" height="100px;"/><br>
							<h5>A House Of Power and Material Handling Solution</h5>
							<h5>Khawaja Tower[2nd Floor],95, Mohakhali C/A, Dhaka-1212</h5>
							<h3>RLP Details</h3>
						</p>
					</center>
				</div>
        ...
        <div class="col-sm-12 table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
					...
					<tr>
                        <td colspan="9"><?php echo $rlp_info->user_remarks;  ?></td>
                    </tr>
                </tbody>
            </table>
			<div class="row">
