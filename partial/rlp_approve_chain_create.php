                            ...
                            <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <select class="form-control" id="rlp_type" name="rlp_type">
                                        <option value="">Please select</option>
                                        <option value="1">General RLP</option>
                                        <option value="2">Stationary RLP</option>
                                        <option value="3">EHS RLP</option>
                                        <option value="4">Battery Stationary RLP</option>
                                    </select>
                                </div>
                            </div>                   
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="chain_select_project_id" name="chain_select_project_id" onchange="getProjectWiseUsers('chain_select_branch_id','chain_select_department_id','chain_select_project_id');">
                                        ...
                                        foreach ($datas as $data) {
                                            ?>
                                            <option value="<?php echo $data->id; ?>"><?php echo $data->division_id .'||'.$data->project_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>                        
                            </div>
