<?php
$rlpListData = getConveyanceRLPListDataW();
            ...
            <tbody>
                ...
                foreach ($rlpListData as $adata) {
                    ...
                    <tr id="row_id_<?php echo $adata->id; ?>">
                        ...
                        <td><?php  echo (isset($adata['totalamount']) && !empty($adata['totalamount']) ? $adata['totalamount'] : 'No data');?></td>
                        ...
                        <td>
                            ...
                            <a title="Edit RLP" class="btn btn-sm btn-info" href="conv_rlp_update.php?rlp_id=<?php echo $adata['id']; ?>">
                            ...
                            <a title="Make Notesheet" class="btn btn-sm btn-info" href="conv_rlp_notesheet.php?rlp_id=<?php echo $adata['id']; ?>">
