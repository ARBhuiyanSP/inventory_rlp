            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <table class="table table-bordered table-striped" id="adjustmentTable">
                        ...
                        <tbody>
                            <tr><td colspan="8" class="text-center text-muted">Select an RLP to view adjustments</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    if (rlpId) {
        ...
        .then(data => {
            ...
            if (data.adjustments.length > 0) {
                ...
                tbody.innerHTML = '<tr><td colspan="8" class="text-center text-muted">No adjustments found for this RLP</td></tr>';
