...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            Transfer Entry Form <a href="transfer_list.php" style="float:right"><i class="fas fa-plus"></i> Transfer List<a></div>
        <div class="card-body">
                    ...
                    <div class="row" id="div1" style="">
                        <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" name="transfer_date" id="issue_date" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                if ($_SESSION['logged']['user_type'] == 'whm') {
                                    ...
                                    $issueCode = 'TR-' . $short_name;
                                } else {
                                    $issueCode = 'TR-CW-';
                                }
                                ?>
                                <input type="text" name="transfer_id" id="issue_id" class="form-control" value="<?php echo getDefaultCategoryCodeByWarehouseT('inv_transfermaster', 'transfer_id', '03d', '001', $issueCode) ?>" readonly>
                                <input type="hidden" name="transfer_no" id="issue_no" value="<?php echo getDefaultCategoryCodeByWarehouseT('inv_transfermaster', 'transfer_id', '03d', '001', $issueCode) ?>">
                            </div>
                        </div>
						<div class="col-xs-2">
                            <div class="form-group">
								...
								<input name="from_project" type="hidden" value="<?php echo $_SESSION['logged']['project_id']; ?>" />
                            </div>
                        </div>
                        <div class="col-xs-2">
							<div class="form-group">
                                <label>From Warehouse</label>
								 ...
								 <input name="from_warehouse" type="hidden" value="<?php echo $_SESSION['logged']['warehouse_id']; ?>" />
                        ...
                        <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <select class="form-control material_select_2" id="project_id" name="to_project"  required >
                        ...
                        <div class="col-xs-2">
							<div class="form-group">
                                ...
                                <select class="form-control material_select_2" id="warehouse_id" name="to_warehouse" required >
                                    <option value="">Select</option>
									<?php
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <div class="modal-footer">
                                    <input type="submit" name="transfer_submit" id="transfer_submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="Save" />
                                </div>    
                            </div>
                        </div>
                    </div>
