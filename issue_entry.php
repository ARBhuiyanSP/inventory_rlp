                ...
                <form action="" method="post" name="add_issue" id="issue_entry_form" enctype="multipart/form-data" onsubmit="showFormIsProcessing('issue_entry_form');">
                    <div class="row" id="div1" style="">
                        ...
                        <div class="col-xs-2">
							<div class="form-group">
								<label>Use In</label>
								<select class="form-control select2" id="use_in" name="use_in" required >
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
								...
								<input name="project_id" type="hidden" value="<?php echo $_SESSION['logged']['project_id']; ?>" />
								<input name="warehouse_id" type="hidden" value="<?php echo $_SESSION['logged']['warehouse_id']; ?>" />
                            </div>
                        </div>
                        <div class="col-xs-3">
							<div class="form-group">
                                <label>Consumption By</label>
                                <?php 
