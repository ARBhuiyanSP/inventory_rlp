        ...
        <form name="" action="" method="GET">
			<div class="col-xs-2">
				<div class="form-group">
					...
					<select class="form-control select2" id="level_1_id_l5" name="parent_item_id" onchange="getMatByParent(this.value);">
			...
			<div class="col-xs-2">
				<div class="form-group">
					...
					<select class="form-control select2" id="level_2_id_l5" name="item_id">
						<option value="">Select</option>
						<?php
