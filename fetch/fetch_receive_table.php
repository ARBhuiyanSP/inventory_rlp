...
$column = array("inv_receive.id", "inv_receive.mrr_no", "inv_receive.mrr_date", "vendors.vendor_name", "vendors.vendor_id", "inv_receive.receive_total");
$query = "
 SELECT *,inv_receive.id as voucher_id FROM inv_receive 
 INNER JOIN vendors 
 ON vendors.vendor_id = inv_receive.supplier_id 
";
$query .= " WHERE 1=1 AND  ";
