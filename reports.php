    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <div class="row">
							...
							<div class="col-sm-4">
								<?php if(check_permission('material-receive-reports')){ ?>
								...
								<?php if(check_permission('transfer-reports')){ ?>
								...
								<?php if(check_permission('consumption-issue-reports')){ ?>
							...
							<div class="col-sm-4">
								<?php if(check_permission('rlp-reports')){ ?>
								<h5>RLP Reports</h5>
								<ul>
									<a href="rlp_report.php"><li><b>Project & Datewise RLP Report</b></li></a>
								</ul>
								<?php } ?>
								<?php if(check_permission('summary-reports')){ ?>
						   ...
						   <div class="col-sm-4">
								<?php if(check_permission('notesheet-reports')){ ?>
								...
								<?php if(check_permission('workorders-reports')){ ?>
								...
								<?php if(check_permission('material-stock-reports')){ ?>
