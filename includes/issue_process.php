		...
		$_SESSION['warning']    =   "Operation faild. Duplicate data found..!";
			...
			for ($count = 0; $count < count($_POST['quantity']); $count++) {
				...
				*/       
				...
				$query = "INSERT INTO `inv_issuedetail` (`issue_id`,`issue_date`,`material_id`,`material_name`,`unit`,`issue_qty`,`issue_price`,`part_no`,`use_in`,`project_id`,`warehouse_id`,`store_id`,`approval_status`) VALUES ('$issue_id','$issue_date','$material_id','$material_name','$unit','$quantity','$unit_price','$part_no','$use_in','$project_id','$warehouse_id','$store_id','0')";
				$conn->query($query);
				...
				*/
				...
				$query_inmb = "INSERT INTO `inv_materialbalance` (`mb_ref_id`,`mb_materialid`,`eel_code`,`mb_date`,`mbin_qty`,`mbin_val`,`mbout_qty`,`mbout_val`,`mbprice`,`mbtype`,`mbserial`,`mbserial_id`,`mbunit_id`,`jvno`,`part_no`,`project_id`,`warehouse_id`,`store_id`) VALUES ('$mb_ref_id','$mb_materialid','$use_in','$mb_date','$mbin_qty','$mbin_val','$mbout_qty','$mbout_val','$mbprice','$mbtype','$mbserial','$mbunit_id','$unit','$jvno','$part_no','$project_id','$warehouse_id','$store_id')";
				$conn->query($query_inmb);
			}
			/*
			*  Insert Data Into inv_issue Table:
			*/
			$query2 = "INSERT INTO `inv_issue` (`issue_id`,`issue_date`,`use_in`,`total_amount`,`remarks`,`company_id`,`division_id`,`project_id`,`warehouse_id`,`store_id`,`issued_by`,`issue_image`) VALUES ('$issue_id','$issue_date','$use_in','$total_amount','$remarks','$company_id','$division_id','$project_id','$warehouse_id','$store_id','$issued_by','$issue_image')";
