...
if (isset($_POST['receive_submit']) && !empty($_POST['receive_submit'])) {
    ...
    for ($count = 0; $count < count($_POST['quantity']); $count++) {
        ...
        */ 
        ...
        $requisitionno     = $_POST['requisition_no'];
        $ns_no     = $_POST['ns_no'];
        ...
        $query = "INSERT INTO `inv_receivedetail` (`mrr_no`,`material_id`,`material_name`,`unit_id`,`receive_qty`,`unit_price`,`sl_no`,`total_receive`,`part_no`,`project_id`,`warehouse_id`,`store_id`,`approval_status`) VALUES ('$mrr_no','$material_id','$material_name','$unit','$quantity','$unit_price','1','$totalamount','$part_no','$project_id','$warehouse_id','$store_id','$approval_status')";
        $conn->query($query);
        ...
        */
        ...
        $query_inmb = "INSERT INTO `inv_materialbalance` (`mb_ref_id`,`mb_materialid`,`material_name`,`mb_date`,`mbin_qty`,`mbin_val`,`mbout_qty`,`mbout_val`,`mbprice`,`mbtype`,`mbserial`,`mbserial_id`,`mbunit_id`,`jvno`,`part_no`,`project_id`,`warehouse_id`,`store_id`,`approval_status`) VALUES ('$mb_ref_id','$mb_materialid','$material_name','$mb_date','$mbin_qty','$mbin_val','$mbout_qty','$mbout_val','$mbprice','$mbtype','$mbserial','$mbunit_id','$unit','$jvno','$part_no','$project_id','$warehouse_id','$store_id','$approval_status')";
        $conn->query($query_inmb);
		
		$queryPro = "INSERT INTO `inv_product_price`(`mrr_no`,`material_id`, `receive_details_id`, `qty`,`price`,`part_no`,`project_id`,`warehouse_id`,`store_id`, `status`) VALUES ('$mb_ref_id','$mb_materialid','$lastinsertedId','$mbin_qty','$mbprice','$part_no','$project_id','$warehouse_id','$store_id','1')";
        $conn->query($queryPro); 
