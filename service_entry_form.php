			...
			<div class="col-sm-12">	
				...
				<form action="" method="post" name="add_name" id="receive_entry_form" enctype="multipart/form-data" onsubmit="showFormIsProcessing('receive_entry_form');">
					<div class="row" id="div1" style="">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<?php 
									...
									$b_store = $row['current_store'];
									$sql	=	"SELECT * FROM store WHERE `id`='$b_store'";
									$result = mysqli_query($conn, $sql);
									$rows=mysqli_fetch_array($result);
									$short_name = $rows['keyword'];
									$mrrcode= $short_name.'-SRV-';
									
									$b_store = $row['current_store'];
								?>
								<input type="text" name="" id="" class="form-control" value="<?php echo getDefaultCategoryCodeByStore2('inv_services', 'srv_no', '03d', '001', $mrrcode,$b_store) ?>" readonly>
								<input type="hidden" name="srv_no" id="srv_no" value="<?php echo getDefaultCategoryCodeByStore2('inv_services', 'srv_no', '03d', '001', $mrrcode,$b_store) ?>">
							</div>
						</div>
						...
						<input type="hidden" name="proloc_id" value="<?php echo $row['proloc_id'] ?>">
						<input type="hidden" name="current_store" value="<?php echo $row['current_store'] ?>">
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="vendor" name="vendor" class="form-control select2" required >
